...
OpGroupAsyncCopyGlobalToLocal(__spv::Scope::Flag Execution, dataT *Dest, dataT *Src,
...
template <typename dataT>
extern __ocl_event_t
OpGroupAsyncCopyLocalToGlobal(__spv::Scope::Flag Execution, dataT *Dest, dataT *Src,
                              size_t NumElements, size_t Stride,
                              __ocl_event_t E) noexcept {
  for (size_t i = 0; i < NumElements; i++) {
    Dest[i * Stride] = Src[i];
